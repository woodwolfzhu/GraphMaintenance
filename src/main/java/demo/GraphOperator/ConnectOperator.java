class GraphConnect extends Operator{
...
public static Graph getResult(Graph R, Graph S) {
        ...
        while (graphIteratorR.hasNext()) {
            ...
            while (bottomIteratorR.hasNext()) {
                ...
                Quintuple quintupleR = bottomEntryR.getValue();

                // 取R中五元组中的第二条边的起点为起点
                String startName = quintupleR.getEdge2().getStart().getName();
                // 取R中五元组的第一条边的终点为终点
			    String endName = quintupleR.getEdge1().getEnd().getName();
                ...
                while (quintupleEntryS.hasNext()) {
                    ...
                    if (endName.equals(endName)) {
                        ...
                        if(!quintupleS.getEdge2().getEnd().getName().equals(endName)){
                            continue;
                        }
                        ...
                        GraphEdge edge = new NormalEdge(startName,endName,resultWeightVector);
                        ...
                        resultQuintuple.setEdge2(null);
                        resultQuintuple.setEdge1(edge);
                        bottomResult.put(endName,resultQuintuple);
                    }
                }
            }
